# Phase — `2026-07-19-vertical-slice-replan`

```yaml
sessionId: 2026-07-19-vertical-slice-replan
track: Full
...
- [x] **helper** — auditoria Linear + brief
- [x] **decomposition** — proposta Linear criada
- [x] **planning** — plano de capacidade e dependências
- [x] **challenge** — plano atacado e ajustado
- [x] **approval** — `approvals/2026-07-20-linear-replan.md`
- [x] **team** — N/A; mudança é de planejamento
- [x] **review** — auditoria pós-mutation registrada
- [x] **conclusion** — relatório registrado; publicação depende de solicitação
