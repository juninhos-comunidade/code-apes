...
2. Em planos/specs: citar arquivos, verify profile, aceite `MQ-*`, QG.
...
| 2026-07-18 | Linear SoT issues (`MQ-*`); propor antes de criar | proposal + Approval antes de `save_issue` |
